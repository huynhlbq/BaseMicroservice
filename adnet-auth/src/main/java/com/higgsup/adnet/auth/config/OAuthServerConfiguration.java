package com.higgsup.adnet.auth.config;

import com.higgsup.adnet.auth.service.JdbcUserDetailsService;
...
public class OAuthServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	public OAuthServerConfiguration(AuthenticationManager authenticationManager, DataSource dataSource, JdbcUserDetailsService jdbcUserDetailsService) {
	...
	protected static class AuthenticationManagerConfiguration extends GlobalAuthenticationConfigurerAdapter {
		...
		@Autowired
		public AuthenticationManagerConfiguration(DataSource dataSource, JdbcUserDetailsService jdbcUserDetailsService) {
			this.dataSource = dataSource;
			this.jdbcUserDetailsService = jdbcUserDetailsService;
		}
